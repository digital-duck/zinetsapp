<template>
  <div class="character-details">
    <el-card class="details-card">
      ...
      <div v-if="!character" class="no-selection">
        <el-empty 
            ...
            <div class="tab-content">
              <div class="detail-section">
                ...
                <div class="detail-text">
                  {{ characterData?.meaning || 'Loading meaning...' }}
                </div>
              </div>
              ...
              <div class="detail-section">
                <h4>Composition</h4>
                <div class="detail-text">
                  {{ characterData?.composition || 'Loading composition...' }}
                </div>
              </div>
            </div>
          </el-tab-pane>
            ...
            <div class="tab-content">
              <div class="detail-section">
                ...
                <div 
                  ...
                  v-html="characterData?.phrases || 'Loading phrases...'"
                />
              </div>
            </div>
          </el-tab-pane>
            ...
            <div class="tab-content">
              <div class="detail-section">
                ...
                <p class="search-description">
                  Search for "{{ character }}" in online dictionaries and resources:
                </p>
...
export default {
  ...
  setup(props, { emit }) {
    ...
    function refreshCharacterData() {
      if (props.character) {
        emit('refresh-character', props.character)
      }
    }
    
    function openSearch(site) {
      if (props.character) {
        const url = site.url + encodeURIComponent(props.character)
        window.open(url, '_blank', 'noopener,noreferrer')
      }
    }
    
    function getDataStatusType() {
      if (!props.characterData) return 'info'
      
      if (props.characterData.pinyin === 'Unknown') {
        return 'warning'
      }
    ...
    function getDataStatusText() {
      if (!props.characterData) return 'Loading...'
