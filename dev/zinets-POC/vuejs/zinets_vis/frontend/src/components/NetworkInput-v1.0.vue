...
export default {
  ...
  setup(props, { emit }) {
    ...
    function validateMarkdown() {
      ...
      validationResult.value = MarkdownParser.validateMarkdown(content)
      
      if (validationResult.value.valid) {
        ElMessage.success('Markdown format is valid!')
      } else {
        ElMessage.error('Markdown format has errors. Please check and fix them.')
      }
    }
    ...
    async function handleSubmit() {
      ...
      if (!validation.valid) {
        ElMessage.error('Please fix markdown errors before loading')
        return
      }
