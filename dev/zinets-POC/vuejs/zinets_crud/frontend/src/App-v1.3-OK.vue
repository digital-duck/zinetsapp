<template>
  <div class="container">
    <h3>Chinese Character Manager</h3>
    ...
    <div class="search-container">
      <el-form :inline="true" class="search-form">
        ...
        <el-form-item label="Model">
          <el-input
            v-model="searchParams.llm_model_name"
            placeholder="model"
            clearable
            style="width: 100px"
          />
  ...
  setup() {
    ...
    watch(
      () => [
        ...
        searchParams.pinyin,
        searchParams.meaning, 
        searchParams.llm_provider, 
        searchParams.llm_model_name,
        searchParams.is_active,
        searchParams.is_best
      ],
      () => {
        // Debounce search
