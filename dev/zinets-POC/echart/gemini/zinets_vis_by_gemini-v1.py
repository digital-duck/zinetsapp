...
if __name__ == "__main__":
    ...
    if test_case_1:
        ...
        output_file = process_semantic_network(zi_network, output_file="zinets_vis_2.html")
    ...
    if test_case_2:
        ...
        output_file = process_semantic_network(zi_network, output_file="zi_vis_2.html")
